...
conn = st.connection("postgresql", type="sql", 
                     url="postgresql://nasraniasella314:m7cH9ZvrzXsT@ep-yellow-butterfly-65120997.us-east-2.aws.neon.tech/web")
...
st.header('SIMPLE HOSPITAL DATA MANAGEMENT SELLA njnj')
